...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Level of latent process with forecast. Shaded region is $\pm$ 1 standard deviation. From 1950 to 2011 shows smoothed values, from 2012 shows forecast.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figs/sweden_1952_2011_Male_100_1_3latent_trend.pdf}
        \caption{Trend of latent process. Shaded region is $\pm$ 1 standard deviation.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
...
\begin{figure}
    ...
    \end{subfigure}
       \caption{Mortality forecasts for four different age groups. Solid line is the smoothed mortality rate, dashed line is the mean forecasted mortality rate and shaded region is $\pm$ 1 standard deviation of the forecasted observed mortality rate.}
...
\begin{table}[h!]
    ...
    \caption{Out-of-sample model evaluation metrics for Sweden. Numbers are averaged over all forecast horizons and training/evaluations periods.}
\end{table}
%         Log score	    naive	    saturated	R2	        relative
% LC	    -608.482678	    -794.965564	-344.072618	0.215000	1.769242
% Plat    -474.918951	    -794.965564	-344.072618	0.608068	1.380638
% VI      -455.137394	    -794.965564	-344.072618	0.663549	1.323074
